            ...
            child: Padding(
              ...
              child: Row(
                children: [
                  ...
                  // Logo and title section - Made flexible
                  Expanded(
                    child: Row(
                      children: [
                        // Shield icon
                        ...
                        // Title section - Made flexible with overflow handling
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            mainAxisAlignment: MainAxisAlignment.center,
                            ...
                            children: [
                              ...
                              SizedBox(height: 3), // Increased from 2
                              ...
                              Flexible(
                                child: FittedBox(
                                  ...
                                  alignment: Alignment.centerLeft,
                                  child: Container(
                                    padding: EdgeInsets.symmetric(horizontal: 6, vertical: 2), // Increased padding
                                    decoration: BoxDecoration(
                                      border: Border.all(
                                        color: Color(0xFF00FFE0).withOpacity(0.3),
                                        width: 1,
                                      ),
                                      borderRadius: BorderRadius.circular(4), // Increased from 3
                                      color: Color(0xFF00FFE0).withOpacity(0.05),
                                    ),
                                    child: Text(
                                      'ARYA\'S DIGITAL DAY',
                                      style: TextStyle(
                                        ...
                                        fontWeight: FontWeight.w600,
                                        color: Color(0xFF00FFE0),
                                        letterSpacing: 1.2, // Increased from 1.0
                                      ),
                                    ),
                                  ),
                                ),
                  ...
                  SizedBox(width: 8), // Add some space before status indicator
                  
                  // Status indicators - Made more compact
                  Container(
                    child: Container(
                      padding: EdgeInsets.symmetric(horizontal: 6, vertical: 4), // Made more compact
                      decoration: BoxDecoration(
                        border: Border.all(
                          color: Color(0xFF00FF88).withOpacity(0.5),
                          width: 1,
                      ...
                      child: Row(
                        mainAxisSize: MainAxisSize.min, // Important: minimize the row size
                        children: [
                          Icon(
                            Icons.signal_cellular_alt,
                            color: Color(0xFF00FF88),
